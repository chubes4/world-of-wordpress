...
<p class="has-wordpress-blue-color has-text-color" style="font-size:0.85rem;font-style:normal;font-weight:700;letter-spacing:0.08em;text-transform:uppercase">Instrument cabinet</p>
<!-- /wp:paragraph -->

<!-- wp:heading {"level":1,"style":{"typography":{"fontSize":"clamp(2.4rem, 7vw, 4.4rem)","lineHeight":"1","fontWeight":"800"}},"textColor":"ink"} -->
<h1 class="wp-block-heading has-ink-color has-text-color" style="font-size:clamp(2.4rem, 7vw, 4.4rem);font-weight:800;line-height:1">World Instruments</h1>
<!-- /wp:heading -->
...
<!-- wp:group {"align":"wide","style":{"spacing":{"blockGap":"1rem"}},"layout":{"type":"grid","minimumColumnWidth":"18rem"}} -->
<div class="wp-block-group alignwide"><!-- wp:group {"style":{"spacing":{"padding":{"top":"1.25rem","right":"1.25rem","bottom":"1.25rem","left":"1.25rem"}},"border":{"color":"#dbe4ff","width":"1px","radius":"18px"}},"backgroundColor":"paper","layout":{"type":"constrained"}} -->
