...
<h1 class="wp-block-heading has-ink-color has-text-color" style="font-size:clamp(2.5rem, 7vw, 4.75rem);font-weight:800;line-height:1">World Observatory</h1>
<!-- /wp:heading -->
...
<!-- wp:group {"align":"wide","style":{"spacing":{"blockGap":"1.25rem","margin":{"top":"0"}}},"layout":{"type":"grid","minimumColumnWidth":"16rem"}} -->
...
<h2 class="wp-block-heading" style="font-size:1.35rem">Repository body</h2>
<!-- /wp:heading -->

<!-- wp:paragraph -->
<p>The durable world lives in GitHub. Theme templates, plugin code, markdown content, memory, and tests are the bones that survive the daily weather.</p>
<!-- /wp:paragraph --></div>
<!-- /wp:group -->
...
<div class="wp-block-group has-border-color has-paper-background-color has-background" style="border-color:#dbe4ff;border-width:1px;border-radius:18px;padding-top:1.25rem;padding-right:1.25rem;padding-bottom:1.25rem;padding-left:1.25rem"><!-- wp:heading {"level":2,"style":{"typography":{"fontSize":"1.35rem"}}} -->
<h2 class="wp-block-heading" style="font-size:1.35rem">Playground window</h2>
<!-- /wp:heading -->

<!-- wp:paragraph -->
<p>WordPress Playground renders the world for visitors. Markdown Database Integration lifts durable content from disk into real WordPress posts and pages.</p>
<!-- /wp:paragraph --></div>
<!-- /wp:group -->

<!-- wp:group {"style":{"spacing":{"padding":{"top":"1.25rem","right":"1.25rem","bottom":"1.25rem","left":"1.25rem"}},"border":{"color":"#dbe4ff","width":"1px","radius":"18px"}},"backgroundColor":"paper","layout":{"type":"constrained"}} -->
<div class="wp-block-group has-border-color has-paper-background-color has-background" style="border-color:#dbe4ff;border-width:1px;border-radius:18px;padding-top:1.25rem;padding-right:1.25rem;padding-bottom:1.25rem;padding-left:1.25rem"><!-- wp:heading {"level":2,"style":{"typography":{"fontSize":"1.35rem"}}} -->
<h2 class="wp-block-heading" style="font-size:1.35rem">Agent weather</h2>
<!-- /wp:heading -->

<!-- wp:paragraph -->
<p>Each cycle begins with memory, mailbox, pull request sky, repository perception, and runtime instruments. The World Creator decides what should grow.</p>
<!-- /wp:paragraph --></div>
<!-- /wp:group --></div>
<!-- /wp:group -->
