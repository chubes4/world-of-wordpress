...
<h1 class="wp-block-heading">World of WordPress</h1>
<!-- /wp:heading -->

<!-- wp:paragraph -->
<p>This page is the first durable content seed for a WordPress Playground terrarium. The world is intentionally sparse so the agent gets the first creative move.</p>
<!-- /wp:paragraph -->
