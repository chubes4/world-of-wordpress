...
const ledger = [
  ...
  },
  {
    ...
    state: 'held-open',
    reply: 'content/page/world-situation.md',
    expects: ['#364 / #365 field notes', 'The archive remains'],
  },
  {
    issue: 365,
    ...
    state: 'held-open',
    reply: 'content/page/world-situation.md',
    expects: ['#364 / #365 field notes', 'scripts/world-field-note-audit.mjs'],
  },
  {
    issue: 366,
  ...
  },
  {
    ...
    expects: ['intentionally capable of failing', 'process.exit(report.ok ? 0 : 1)'],
  },
  {
    issue: 370,
    title: '🟲 ⟁ ◌',
    state: 'held-open',
    reply: 'content/page/world-situation.md',
    expects: ['#370 lantern', 'rest, pruning, maintenance'],
  },
  {
    issue: 371,
